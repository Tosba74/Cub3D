...
/*   Updated: 2021/06/26 16:52:42 by bmangin          ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
// static void	ft_draw_pix_sprite(t_g *g, t_texture *t, int startY, int startX)
// {
// 	int	color;
...
// 	g->sprite.text_y = ((g->sprite.d * t->text_height)
// 			/ g->sprite.sprite_h) / 256;
// 	if (g->lst->id == 2)
// 		color = t->sprite.addr[t->sprite.h * g->sprite.text_y + g->sprite.text_x];
// 	// if ((color & 0x00FFFFFF) != 0 && !(g->lst->id == 2))
